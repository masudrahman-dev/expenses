      ...
      <div className=" flex w-full items-start justify-between">
        ...
        <div className="flex gap-3 items-center  ">
          <div className=" flex items-center -space-x-1 relative ">
            <Avatar src={avatar1Img} className="z-30  hover:z-40 focus:z-40" />
            <Avatar src={avatar2Img} className="z-20  hover:z-40 focus:z-40" />
            <Avatar src={avatar3Img} className="z-10  hover:z-40 focus:z-40" />
          </div>
